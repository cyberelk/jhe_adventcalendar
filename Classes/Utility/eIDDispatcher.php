...
require_once t3lib_extMgm::extPath('jhe_adventcalendar') . 'Classes/Utility/AjaxDispatcher.php';
...
$dispatcher = t3lib_div::makeInstance('Tx_JheAdventcalendar_Utility_AjaxDispatcher'); /** @var $dispatcher Tx_PtExtbase_Utility_AjaxDispatcher */
